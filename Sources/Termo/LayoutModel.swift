...
///
/// 原因:`AppModel` 是被 ContentView / Sidebar / TabBar / Workspace 等几乎所有视图共同
/// 观察的「上帝对象」。若把 `sidebarWidth` 放在它身上,任何一次宽度变化(尤其拖动分隔条时
/// 每帧一次)都会触发 `objectWillChange`,使所有持有 `@ObservedObject var model` 的视图
/// 同帧重算 body —— 标签越多、文件树行越多就越卡。
///
